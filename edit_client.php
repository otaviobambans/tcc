	...
	<body>
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-md-8">
					<form id="edit_client_request">
						<input name="client_access" id="client_access" type="hidden" value=<?php echo $_SESSION['cd_client']; ?>>
					</form>
					<form class="form form-group" id="edit_client">
						<div class="row">
							<div class="col-md-5">
								<hr>
							</div>
						...
						<div class="row">
							...
							<input name="client_identification" id="client_id" type="hidden">
						</div>
						<br>
						<br>
						<div class="row">
							...
							<div class="col-md-6">
								<button type="submit" id="submit_login" class="btn btn-block btn-success">Editar</button>
							</div>
						</div>
					</form>
				</div>
